...
export function pageToPath(p) {
  ...
  switch (p.id) {
    ...
    case "fall-scramble":
      return "/fall-scramble";
    case "fall-scramble-detail":
      return `/fall-scramble/${p.year}`;
    case "fall-scramble-draft":
      return "/fall-scramble/draft";
    case "fall-scramble-betting":
      return "/fall-scramble/betting";
    case "parimutuel":
      return "/parimutuel";
    case "live-betting":
      return "/betting";
...
export function activeNavFromPath(pathname) {
  ...
  if (pathname.startsWith("/fall-scramble")) return "fall-scramble";
